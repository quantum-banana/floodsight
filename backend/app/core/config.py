...
class Settings(BaseSettings):
    ...
    detection_standard_resolution: int = Field(default=640, ge=256, le=2048)
    detection_aerial_resolution: int = Field(default=1280, ge=256, le=2048)
    detection_aerial_tile_overlap: float = Field(default=0.2, ge=0, lt=1)
    detection_aerial_fusion_iou_threshold: float = Field(default=0.5, gt=0, le=1)
    detection_aerial_high_recall_resolution: int = Field(default=1280, ge=256, le=2048)
    detection_aerial_high_recall_tile_overlap: float = Field(default=0.25, ge=0, lt=1)
    detection_aerial_high_recall_person_confidence: float = Field(default=0.5, gt=0, le=1)
    detection_segformer_reinspection_enabled: bool = True
    detection_segformer_reinspection_padding: float = Field(default=0.75, ge=0, le=2)
    detection_segformer_reinspection_min_pixels: int = Field(default=24, ge=1)
